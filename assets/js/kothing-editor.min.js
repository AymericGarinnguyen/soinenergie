          ...
          fontStyle: {
            ...
            add: function (e, t) {
              ...
              n
                .querySelector(".ke-list-inner")
                .addEventListener("click", this.pickup.bind(e)),
                (i.fontStyle._styleList = n.querySelectorAll("ul li button")),
                e.initMenuTarget(this.name, t, n),
                (n = null);
            },
            setSubmenu: function () {
              var e,
                ...
                n = this.lang,
                l = this.util.createElement("DIV");
              l.className = "ke-submenu ke-list-layer ke-list-font-weight";
              for (
                var o = i.fontStyle
                  ? i.fontStyle
                  : [
            ...
            active: function (e) {
              var t = this.context.fontStyle.targetText,
                i = this.context.fontStyle.targetTooltip;
              if (e) {
                if (e.style && 0 < e.style.fontStyle.length) {
                  var n = e.style.fontStyle.replace(/["']/g, "");
                  return this.util.changeTxt(t, n), this.util.changeTxt(i, n), !0;
                }
              } else {
                var l = this.lang.toolbar.fontStyle;
                this.util.changeTxt(t, l), this.util.changeTxt(i, l);
              }
              return !1;
            },
            on: function () {
              var e = this.context.fontStyle,
                t = e._styleList,
                i = e.targetText.textContent;
              if (i !== e.currentStyle) {
                for (var n = 0, l = t.length; n < l; n++)
            ...
            pickup: function (e) {
              ...
              var t,
                i = e.target.getAttribute("data-value");
              i
                ? (((t = this.util.createElement("SPAN")).style.fontWeight = i),
                  this.nodeChange(t, ["font-weight"], null, null))
                : this.nodeChange(null, ["font-weight"], ["span"], !0),
                this.submenuOff();
            },
          },
          fontColor: o,
      ...
      var A = {
        ...
        _initOptions: function (e, t) {
          (t.lang = t.lang || T.a),
            ...
            (t.fontStyle = t.fontStyle ? t.fontStyle : null),
        ...
        _defaultButtons: function (e) {
          ...
          return {
            ...
            fontStyle: [
                "ke-btn-select ke-btn-tool-weight",
                i.toolbar.fontStyle,
                "fontStyle",
                "submenu",
                '<span class="txt">' + i.toolbar.fontStyle + "</span>" + t.arrow_down,
              ],
            fontColor: [
              "",
              i.toolbar.fontColor,
